...
export async function nextStep(userId) {
  ...
  switch (stage) {
    ...
    case 4:
    case 5:
      await processSDLStageWithEvents(userId, stage)
...
async function processSDLStageWithEvents(userId, stage) {
  const requestGroups = getSDLRequestGroupsByUserId(userId, `step0${stage}-sdl`);
